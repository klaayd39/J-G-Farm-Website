...
export function SilageMobileNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-sky-400/10 bg-app-header px-2 pt-1 backdrop-blur-lg md:hidden pb-[max(0.35rem,env(safe-area-inset-bottom))]">
